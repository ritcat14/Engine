...
public class ParticleRenderer {
	...
	protected void render(Map<ParticleTexture, List<Particle>> particles, Camera camera){
		...
		for (ParticleTexture texture : particles.keySet()) {
			...
			for (Particle p : particleList) {
				updateModelViewMatrix(viewMatrix, p, vboData);
	...
	private void updateModelViewMatrix(Matrix4f viewMatrix, Particle p, float[] vboData) {
		...
		Matrix4f.rotate((float) Math.toRadians(rotation), new Vector3f(0,0,2), modelMatrix, modelMatrix);
